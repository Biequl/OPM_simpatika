...
import id.beetechmedia.opmsimpatika.activity.ma.EditOpmma;
 ...
 */
public class AdapterOpmMA extends RecyclerView.Adapter<AdapterOpmMA.VHOpm>{
    ...
    public AdapterOpmMA(Context ctx, List<ModelOpm> listOpm) {
        this.ctx = ctx;
        ...
        public VHOpm(@NonNull View itemView) {
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent kirim = new Intent(ctx, EditOpmma.class);
