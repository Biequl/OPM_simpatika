...
import id.beetechmedia.opmsimpatika.activity.mi.EditOpmmi;
 ...
 */
public class AdapterOpmMI extends RecyclerView.Adapter<AdapterOpmMI.VHOpm>{
    ...
    public AdapterOpmMI(Context ctx, List<ModelOpm> listOpm) {
        this.ctx = ctx;
        ...
        public VHOpm(@NonNull View itemView) {
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent kirim = new Intent(ctx, EditOpmmi.class);
