 ...
 */
public class EditOpmmi extends AppCompatActivity {
    ...
    private void prosesEdit(){
        ...
        Call<ModelRespon> proses = API.ardEditOPMMI(yNO, NSM, MADRASAH, KEC, DESA, NAMAOPM, WAOPM);
        ...
        proses.enqueue(new Callback<ModelRespon>() {
            ...
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                ...
                Toast.makeText(EditOpmmi.this, "Kode : "+ kode + " Pesan : "+pesan, Toast.LENGTH_SHORT).show();
                finish();
            ...
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(EditOpmmi.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
            }
        });
    }
}