...
import id.beetechmedia.opmsimpatika.activity.mts.TambahopmMts;
import id.beetechmedia.opmsimpatika.adapter.AdapterOpmMTs;
import id.beetechmedia.opmsimpatika.adapter.AdapterOpmRA;
 ...
 */
public class OpmraActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OpmraActivity.this, TambahOpmra.class));
            }
        });
        ...
        cariData.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                Call<ModelRespon> proses = API.cariOPMRA(newText);
                ...
                proses.enqueue(new Callback<ModelRespon>() {
                    ...
                    public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                        ...
                        if (kode.equals("1")) {
                            ...
                            adOPM = new AdapterOpmRA(OpmraActivity.this, listOPM);
                    ...
                    public void onFailure(Call<ModelRespon> call, Throwable t) {
                        Toast.makeText(OpmraActivity.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
                        pbOPM.setVisibility(View.GONE);
                    }
                });
                return true;
    ...
    public void retriveOPM(){
        pbOPM.setVisibility(View.VISIBLE);
        APIRequestData API = Retroserver.konekRetrofit().create(APIRequestData.class);
        Call<ModelRespon> proses = API.ardRetriveOPMRA();
        proses.enqueue(new Callback<ModelRespon>() {
            @Override
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                String kode = response.body().getKode();
            ...
            @Override
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(OpmraActivity.this, "Eror : Gagal Terhubung dengan server", Toast.LENGTH_SHORT).show();
                pbOPM.setVisibility(View.GONE);
            }
        });
    }
