 ...
 */
public class EditOpmra extends AppCompatActivity {
    ...
    private void prosesEdit(){
        ...
        Call<ModelRespon> proses = API.ardEditOPMRA(yNO, NSM, MADRASAH, KEC, DESA, NAMAOPM, WAOPM);
        ...
        proses.enqueue(new Callback<ModelRespon>() {
            ...
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                ...
                Toast.makeText(EditOpmra.this, "Kode : "+ kode + " Pesan : "+pesan, Toast.LENGTH_SHORT).show();
                finish();
            ...
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(EditOpmra.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
            }
        });
    }
}