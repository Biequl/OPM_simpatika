package id.beetechmedia.opmsimpatika.activity.ma;
...
import id.beetechmedia.opmsimpatika.adapter.AdapterOpmMA;
 ...
 */
public class OpmmaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OpmmaActivity.this, TambahopmMa.class));
            }
        });
        ...
        cariData.setOnQueryTextListener(new android.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                Call<ModelRespon> proses = API.cariOPMMA(newText);
                ...
                proses.enqueue(new Callback<ModelRespon>() {
                    ...
                    public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                        ...
                        if (kode.equals("1")) {
                            ...
                            adOPM = new AdapterOpmMA(OpmmaActivity.this, listOPM);
                    ...
                    public void onFailure(Call<ModelRespon> call, Throwable t) {
                        Toast.makeText(OpmmaActivity.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
                        pbOPM.setVisibility(View.GONE);
                    }
                });
                return true;
    ...
    public void retriveOPM(){
        pbOPM.setVisibility(View.VISIBLE);
        APIRequestData API = Retroserver.konekRetrofit().create(APIRequestData.class);
        Call<ModelRespon> proses = API.ardRetriveOPMMA();
        proses.enqueue(new Callback<ModelRespon>() {
            @Override
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                String kode = response.body().getKode();
            ...
            @Override
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(OpmmaActivity.this, "Eror : Gagal Terhubung dengan server", Toast.LENGTH_SHORT).show();
                pbOPM.setVisibility(View.GONE);
            }
        });
    }
