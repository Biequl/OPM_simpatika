...
import id.beetechmedia.opmsimpatika.activity.ra.TambahOpmra;
 ...
 */
public class TambahOpmmi extends AppCompatActivity {
    ...
    private void prosesSimpan(){
        ...
        Call<ModelRespon> proses = API.ardCreateMI(NSM, MADRASAH,JENJANG, KEC, DESA, NAMAOPM, WAOPM);
        ...
        proses.enqueue(new Callback<ModelRespon>() {
            ...
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                ...
                Toast.makeText(TambahOpmmi.this, "Kode : "+ kode + " Pesan : "+pesan, Toast.LENGTH_SHORT).show();
                finish();
            ...
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(TambahOpmmi.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
            }
        });
    }
}