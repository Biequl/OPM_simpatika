 ...
 */
public class TambahopmMa extends AppCompatActivity {
    ...
    private void prosesSimpan(){
        ...
        Call<ModelRespon> proses = API.ardCreateMA(NSM, MADRASAH,JENJANG, KEC, DESA, NAMAOPM, WAOPM);
        ...
        proses.enqueue(new Callback<ModelRespon>() {
            ...
            public void onResponse(Call<ModelRespon> call, Response<ModelRespon> response) {
                ...
                Toast.makeText(TambahopmMa.this, "Kode : "+ kode + " Pesan : "+pesan, Toast.LENGTH_SHORT).show();
                finish();
            ...
            public void onFailure(Call<ModelRespon> call, Throwable t) {
                Toast.makeText(TambahopmMa.this, "Gagal Hubungi server", Toast.LENGTH_SHORT).show();
            }
        });
    }
}